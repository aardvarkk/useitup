...
ActiveRecord::Schema.define(:version => 20130712205355) do

  create_table "available_ingredients", :force => true do |t|
    t.integer  "user_id"
  ...
  create_table "measure_conversions", :force => true do |t|
